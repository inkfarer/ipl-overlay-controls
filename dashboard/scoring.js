...
SBUpdateBtn.onclick = () => {
	let teamAInfo = tourneyData.value.data.filter(team => team.id === teamASelect.value)[0];
	let teamBInfo = tourneyData.value.data.filter(team => team.id === teamBSelect.value)[0];
